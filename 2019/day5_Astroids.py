...
def intCode_reset(original_intCode, user_input):
    ...
    while pos < len(intCode):
        ...
        if x == 1:
            ...
            intCode[one_spot] = user_input
            pos += 2
        elif x == 4:
            print(intCode[one_spot])
            pos += 2
        elif x == 5:
            if intCode[one_spot]:
